            ...
            <form id="f1">
                <div class="form-horizontal">        
                    ...
                    <div class="control-group m0 mt1 ">
                        ...
                        <div class="controls">     
                            <label class="inline ml0">                        
                                <input value="{{$userinfo?$userinfo->placename:''}}" type="text" placeholder="" class="w100 mr1" name="txplacename"  id="txplacename" />
                            </label>
...
<script language="javascript" type="text/javascript">
    ...
    function saveuser() {
      if (ckktext('#txid8', 'กรุณาระบุรหัสพนักงาน')) {
            return false;
        }
      if (ckktext('#txfname', 'กรุณาระบุชื่อพนักงาน')) {
            return false;
        }
      $('#btn_save').addClass('hidden');
      $.ajax({
        url: rootContext + 'admin/action',
        type: "POST",
        datatype: "json",
        data: $("#f1").serialize()
