...
<html lang="en">
    ...
    <body  data-root="{{asset('/')}}">
                    ...
                    <ul class="nav ace-nav pull-right">
                        <li class="grey">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                ...
                                @if($tp_count['me']>0)
                                <span class="badge badge-grey">{{$tp_count['me']}}</span>
                                @endif
                            </a>
                            ...
                            <ul style="width: 320px;" class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-closer">                                
                                ...
                                <li class="nav-header">
                                    <i class="icon-ok"></i>
                                    {{$tp_count['me']}} เรื่องที่คุณสร้าง
                                </li>
                                @foreach(EDoc::getListMe('',10)as $d)
                                <li >
                                ...
                                @endforeach
                                <li>
                                    <a href="{{asset('edoc/all?p=me')}}">
                                        ดูเรื่องทั้งหมดที่คุณสร้าง
                                        <i class="icon-arrow-right"></i>
                                    </a>
                                </li>
                                @else
                                <li class="nav-header clearfix">
                                    คุณยังไม่เคยสร้างเอกสารในระบบ
                                </li>
                                <li class="clearfix">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="sidebar {{$hrd->menumin?'menu-min':''}}" id="sidebar">
                <div class="sidebar-shortcuts" id="sidebar-shortcuts">
                    <div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
                        <a href="{{asset('edoc')}}" class="btn btn-small btn-success">
                            <i class="icon-home icon-large"></i>
                        </a>
                        <a href="{{asset('edoc/new')}}" class="btn btn-small btn-info">
                            <i class="icon-pencil"></i>
                        </a>
                        <a href="{{asset('edoc/calendar')}}" class="btn btn-small btn-warning">
                            <i class="icon-calendar"></i>
                        </a>

                        <a href="{{asset('edoc/profile')}}" class="btn btn-small btn-danger">
                ...
                <ul class="nav nav-list">                    
                    ...
                    <li class="{{$p?'':'active'}}">
                        <a href="{{asset('edoc/all')}}" class="">
                            <small>
                                <i class="icon-double-angle-right"></i>
                            </small>
                            <span class="menu-text ">
                                All Document
                                @if(isset($tp_count['all']))
