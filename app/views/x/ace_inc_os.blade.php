            ...
            <div class="sidebar {{$fix_sidebar}}" id="sidebar">
                <div class="sidebar-shortcuts" id="sidebar-shortcuts">
                    <div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
                        ...
                        <a href="{{asset('edoc/new')}}?etype=t2" class="btn btn-small btn-warning" title="รับหนังสือรับเข้า">
                            <i class="icon-circle-arrow-down"></i>
                        </a>

                        <a href="{{asset('edoc/new')}}?etype=t1" class="btn btn-small btn-danger" title="ส่งหนังสือออก">
                ...
                <ul class="nav nav-list">   
                    ...
                    <li class="{{$p=='t2'?'active':''}}">
                        <a href="{{asset('edoc/all?p=t2')}}" class="">
                            <i class="icon-circle-arrow-down red"></i>
                            <span class="menu-text ">
                                หนังสือรับเข้า
                                <span class="badge badge-important">{{isset($tp_count['t2'])?$tp_count['t2']:''}}</span>
                            </span>
                        </a>
                    </li>
                    <li class="{{$p=='t1'?'active':''}}">
                        <a href="{{asset('edoc/all?p=t1')}}" class="">
                            <i class="icon-circle-arrow-up green"></i>
                            <span class="menu-text ">
                                หนังสือส่งออก
                                <span class="badge badge-success">{{isset($tp_count['t1'])?$tp_count['t1']:''}}</span>
                            </span>
                        </a>
                    </li>
                    ...
                    <li class="{{$mn=='assign_me'?'active':''}}">
                        <a href="{{asset('edoc/assign_me')}}" class="">
                            ...
                            <span class="menu-text ">
                                งานเข้า
                                @if(($tp_count['in'])>0)
                                <span class="badge badge-important">{{isset($tp_count['in'])?$tp_count['in']:''}}</span>
                                @else
                                <span class="badge badge-light">{{isset($tp_count['in_all'])?$tp_count['in_all']:''}}</span>
                                @endif
                            </span>
                        </a>
                    </li>
                    <li class="{{$mn=='assign_to'?'active':''}}">
                        <a href="{{asset('edoc/assign_to')}}" class="">
                            ...
                            <span class="menu-text ">
                                ...
                                <span class="badge badge-light">{{isset($tp_count['out'])?$tp_count['out']:''}}</span>
                                @endif
                            </span>
                        </a>
                    </li>
                    <li class="{{$mn=='tag_me'?'active':''}}">
                        <a href="{{asset('edoc/tag_me')}}" class="">
                            ...
                            <span class="menu-text ">
                                ...
                                <span class="badge badge-purple">{{isset($tp_count['mail_new'])?$tp_count['mail_new']:''}}</span>
                                @elseif(isset($tp_count['mail']))
                                <span class="badge badge-light">{{isset($tp_count['mail'])?$tp_count['mail']:''}}</span>
                                @endif
                            </span>
                        </a>
                    </li>
