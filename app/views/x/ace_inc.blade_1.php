            ...
            <div class="sidebar {{$fix_sidebar}}" id="sidebar">
                <div class="sidebar-shortcuts" id="sidebar-shortcuts">
                    <div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
                        ...
                        <a href="{{asset('edoc/new')}}?etype={{$etype}}" class="btn btn-small btn-info" title="สร้างเอกสารใหม่">
                ...
                <ul class="nav nav-list">   
                    ...
                    @if(0)
                    <li class="{{$mn=='jobact'?'active':''}}">
                        <a href="{{asset('edoc/jobact')}}" class="">
                            <i class="icon-stackexchange orange"></i>
                            <span class="menu-text ">
                                สถานะงานในฝ่าย
                                <span class="badge badge-light">{{isset($tp_count['faq'])?$tp_count['faq']:'0'}}</span>
                            </span>
                        </a>
                    </li>
                    @endif
                    <li class="{{$mn=='faq'?'active':''}}">
                        <a href="{{asset('edoc/faq')}}" class="">
                            <i class="icon-question"></i>
                            <span class="menu-text ">
                                FAQ
                                <span class="badge badge-light">{{$tp_count['faq']}}</span>
                            </span>
                        </a>
                    </li>
                    <li class="{{$p&&$p!='me'?'active':''}} default ">
                        ...
                        <ul class="submenu" style="display: block;">
                            ...
                            @if(($d->type_id!='faq')&&(isset($tp_count[$d->type_id])||1))
            ...
            <div class="main-content">
                ...
                <div class="page-content clearfix">                        
                    ...
                    <div class="pull-right clearfix grey pr1 text-right">
                        <span class="pink">CAT TELECOM PUBLIC COMPANY LIMITED</span><br/>
                        <span class="text-muted"></span> eDocument Plus<br/> <span class="lighter">@cattelecom.com</span>
                    </div>
                </div><!--/.page-content-->
                @if(0)
