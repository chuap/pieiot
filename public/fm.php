...
//echo $_SESSION['catid'];
//if ($_SESSION['catid']!='01000062'){echo 'Error!!!!!!!!!!!';exit();} 
//a:9:{s:4:"lang";s:2:"en";s:9:"auth_pass";s:32:"d41d8cd98f00b204e9800998ecf8427e";s:8:"quota_mb";i:0;s:17:"upload_ext_filter";a:0:{}s:19:"download_ext_filter";a:0:{}s:15:"error_reporting";i:1;s:7:"fm_root";s:0:"";s:17:"cookie_cache_time";i:2592000;s:7:"version";s:5:"0.9.8";}
/*--------------------------------------------------
 | PHP FILE MANAGER
 +--------------------------------------------------
...
// +--------------------------------------------------	
    ...
    function get_client_ip() {
        ...
        else if(array_key_exists('HTTP_X_FORWARDED', $_SERVER)) $ipaddress = $_SERVER['HTTP_X_FORWARDED'];
        else if(array_key_exists('HTTP_FORWARDED_FOR', $_SERVER)) $ipaddress = $_SERVER['HTTP_FORWARDED_FOR'];
        else if(array_key_exists('HTTP_FORWARDED', $_SERVER)) $ipaddress = $_SERVER['HTTP_FORWARDED'];
    ...
    function getServerURL() {
        $url = (array_key_exists('HTTPS', $_SERVER) == "on")?"https://":"http://";
        $url .= $_SERVER["SERVER_NAME"]; // $_SERVER["HTTP_HOST"] is equivalent
        if (array_key_exists('SERVER_PORT', $_SERVER)!= "80") $url .= ":".$_SERVER["SERVER_PORT"];
        return $url;
    }
...
// +--------------------------------------------------
if ($loggedon==isset($auth_pass) ? $auth_pass : ''){
    switch ($frame){
...
function et($tag){
    ...
    $kr['ConfSaved'] = '�??경�?� 저�?��??�?�?��??�?�';
    $kr['PassSaved'] = '�?밀�?�?� 저�?�';
    $kr['FileDirExists'] = '�??�?� �??�?� 디�?�?�리가 �?�미 존�?�합�??�?�';
    $kr['NoPhpinfo'] = 'PHPINFO()를 �?��?�할�?? �?�?��??�?�';
    $kr['NoReturn'] = '�?�??값 �?�??';
    $kr['FileSent'] = '�??�?� �?�?�';
    $kr['SpaceLimReached'] = '저�?�공가 여�?�가 �?�?��??�?�';
    $kr['InvExt'] = '�?��?��?지 �?�?� �?��?��??';
    $kr['FileNoOverw'] = '�??�?��?? �?�어 쓸�?? �?�?��??�?�';
    $kr['FileOverw'] = '�??�?��?? �?�어 �?��?��??�?�';
    $kr['FileIgnored'] = '�??�?��?� 무�??�??�?�?��??�?�';
    $kr['ChkVer'] = '�?�?? �??�?�? �?��?�';
    $kr['ChkVerAvailable'] = '�??�?�?� �?�?�?� �??�?��??�?�. �?��?��?�?�려면 �?�릭�?�?��?�!!';
    $kr['ChkVerNotAvailable'] = '�??�?�?� �?�?�?� �?�?��??�?�. :(';
    $kr['ChkVerError'] = '연결 �?��?';
    $kr['Website'] = '�?��?��?��?�';
    $kr['SendingForm'] = '�??�?��?? �?�?�중�?��??�?�. 기�?�리�?��?�';
    $kr['NoFileSel'] = '�??�?��?� �?��??�??지 �?�?�?��??�?�';
    $kr['SelAll'] = '모든';
    $kr['SelNone'] = '�?�?';
    $kr['SelInverse'] = '역';
    ...
    $de1['ConfExec'] = 'Bestätige AUSF�?HRUNG';
    ...
    $de2['ConfExec'] = 'Bestätigung AUSF�?HREN';
    ...
    $de2['ChkVer'] = '�?berprüfe neuer Version';
	...
	// Ро�?�?и�? - Евгений Ра�?ев
	$ru['Version']='Вер�?и�?';
	$ru['DocRoot']='Док�?мен�? Root ';
	$ru['FLRoot']='Файлов�?й менеджер';
	$ru['Name']='�?м�?';
	$ru['And']='и';
	$ru['Enter']='Enter';
	$ru['Send']='�?�?прави�?�?';
	$ru['Refresh']='�?бнови�?�?';
	$ru['SaveConfig']='Сохрани�?�? кон�?иг�?ра�?и�?';
	$ru['SavePass']='Сохрани�?�? парол�?';
	$ru['SaveFile']='Сохрани�?�? �?айл ';
	$ru['Save']='Сохрани�?�?';
	$ru['Leave']='�?�?�?ав�?';
	$ru['Edit']='�?змени�?�?';
	$ru['View']='�?ро�?мо�?р';
	...
	$ru['Rem']='Удали�?�?';
	$ru['Compress']='Сжа�?�?';
	$ru['Decompress']='Ра�?пакова�?�?';
	$ru['ResolveIDs']='�?предел�?�?�? id';
	$ru['Move']='�?ереме�?�?и�?�?';
	$ru['Copy']='�?опирова�?�?';
	$ru['ServerInfo']='�?н�?о о �?ервере';
	$ru['CreateDir']='Созда�?�? папк�?';
	$ru['CreateArq']='Создай�?е �?айл ';
	$ru['ExecCmd']='В�?полни�?�?';
	$ru['Upload']='Загр�?зи�?�?';
	$ru['UploadEnd']='Загр�?жено';
	$ru['Perm']='�?рава';
	$ru['Perms']='Разре�?ени�?';
	$ru['Owner']='Владеле�?';
	$ru['Group']='Гр�?ппа';
	...
	$ru['Dir_s']='�?ап..';
	$ru['To']='в';
	$ru['Destination']='�?азна�?ение';
	$ru['Configurations']='�?он�?иг�?ра�?и�?';
	$ru['JSError']='�?�?ибка JavaScript';
	$ru['NoSel']='не�? в�?бранн�?х �?лемен�?ов';
	$ru['SelDir']='В�?бери�?е папк�? назна�?ени�? на левом дереве ';
	$ru['TypeDir']='Введи�?е им�? ка�?алога ';
	$ru['TypeArq']='Введи�?е им�? �?айла';
	$ru['TypeCmd']='Введи�?е команд�? ';
	$ru['TypeArqComp']='Введи�?е им�? �?айла ,ра�?�?ирение\\n �?�?о позволи�? определи�?�? �?ип �?жа�?и�? \\n �?ример:.. \\n nome.zip \\n nome.tar \\n nome.bzip \\n nome.gzip ';
	$ru['RemSel']='Удали�?�? в�?бранн�?е �?лемен�?�?';
	$ru['NoDestDir']='не�? в�?бранного ка�?алога назна�?ени�?';
	$ru['DestEqOrig']='�?рои�?хождение и назна�?ение ка�?алогов равн�? ';
	$ru['InvalidDest']='�?азна�?ение ка�?алога недей�?�?ви�?ел�?но';
	$ru['NoNewPerm']='�?ов�?е разре�?ени�? не �?�?�?ановлен�?';
	$ru['CopyTo']='�?опирова�?�? в ';
	$ru['MoveTo']='�?ереме�?�?и�?�? в';
	$ru['AlterPermTo']='�?зменение разре�?ений в ';
	$ru['ConfExec']='�?од�?верди�?�? ВЫ�?�?�?�?�?ТЬ ';
	$ru['ConfRem']='�?од�?верди�?�? УД�?�?Е�?�?Е';
	$ru['EmptyDir']='�?�?�?�?ой ка�?алог ';
	$ru['IOError']='I/O Error';
	$ru['FileMan']='PHP Файлов�?й менеджер ';
	$ru['TypePass']='Введи�?е парол�?';
	$ru['InvPass']='�?еверн�?й парол�?';
	$ru['ReadDenied']='До�?�?�?п запре�?ен ';
	$ru['FileNotFound']='Файл не найден';
	$ru['AutoClose']='Закр�?�?�? полно�?�?�?�? ';
	$ru['OutDocRoot']='Файл�? за пределами DOCUMENT_ROOT';
	$ru['NoCmd']='�?�?ибка: �?е поддерживаема�? команда';
	$ru['ConfTrySave']='Файл без прав на запи�?�?. \\n Сохрани�?�? в л�?бом �?л�?�?ае. ';
	$ru['ConfSaved']='�?он�?иг�?ра�?и�? �?охранена';
	$ru['PassSaved']='�?арол�? �?охранен';
	$ru['FileDirExists']='Файл или ка�?алог �?же �?�?�?е�?�?в�?е�?';
	$ru['NoPhpinfo']='Ф�?нк�?и�? PHPInfo о�?кл�?�?ена';
	$ru['NoReturn']='�?е�? возвра�?а';
	$ru['FileSent']='Файл о�?правлен';
	$ru['SpaceLimReached']='До�?�?игн�?�? предел �?ро�?�?ран�?�?ва';
	$ru['InvExt']='�?еверное ра�?�?ирение';
	$ru['FileNoOverw']='Файл не може�? б�?�?�? перезапи�?ан ';
	$ru['FileOverw']='Файл перезапи�?�?вае�?�?�?';
	$ru['FileIgnored']='Файл игнорир�?е�?�?�?';
	$ru['ChkVer']='�?ровери�?�? обновление';
	$ru['ChkVerAvailable']=' До�?�?�?пна нова�? вер�?и�?, нажми�?е зде�?�?, �?�?об�? на�?а�?�? загр�?зк�?! ';
	$ru['ChkVerNotAvailable']='�?е�? новой вер�?ии. :(';
	$ru['ChkVerError']='�?�?ибка подкл�?�?ени�?. ';
	$ru['Website']='Сай�?';
	$ru['SendingForm']='�?�?правка �?айлов, пожал�?й�?�?а, подожди�?е ';
	$ru['NoFileSel']='�?е�? в�?бранн�?х �?айлов';
	$ru['SelAll']='В�?дели�?�? в�?е';
	$ru['SelNone']='�?�?мена';
	$ru['SelInverse']='�?бра�?и�?�?';
	$ru['Selected_s']='В�?бран';
	$ru['Total']='В�?его';
	$ru['Partition']='Раздел';
	$ru['RenderTime']='Скрип�? в�?полнен за';
	$ru['Seconds']='Сек�?нд';
	$ru['ErrorReport']='�?�?�?е�? об о�?ибках';
...
function remove_special_chars($str){
    $str = trim($str);
    $str = strtr($str,"¥µÀ�?�?�?�?Å�?�?�?�?�?�?�?�?�?�?�?ÑÒÓÔÕÖ�?�?�?�?�?�?�?àáâãäåæçèéêëìíîïðñòóôõöøùúûüýÿ!@#%&*()[]{}+=?",
...
function dir_list_form() {
    ...
    if ($opdir = @opendir($current_dir)) {
        ...
        $uplink = "";
        if ($current_dir != $fm_current_root ||true){
...
function config_form(){
	...
	<select name=newlang>
        ...
        <option value=ru>Russian - by Евгений Ра�?ев
...
class zip_file extends archive
{
    ...
    function create_zip()
    {
        ...
        foreach($this->files as $current)
        {
            ...
            $translate =  array('�?'=>pack("C",128),'ü'=>pack("C",129),'é'=>pack("C",130),'â'=>pack("C",131),'ä'=>pack("C",132),
                                'à'=>pack("C",133),'å'=>pack("C",134),'ç'=>pack("C",135),'ê'=>pack("C",136),'ë'=>pack("C",137),
                                'è'=>pack("C",138),'ï'=>pack("C",139),'î'=>pack("C",140),'ì'=>pack("C",141),'�?'=>pack("C",142),
                                'Å'=>pack("C",143),'�?'=>pack("C",144),'æ'=>pack("C",145),'�?'=>pack("C",146),'ô'=>pack("C",147),
                                'ö'=>pack("C",148),'ò'=>pack("C",149),'û'=>pack("C",150),'ù'=>pack("C",151),'_'=>pack("C",152),
                                'Ö'=>pack("C",153),'�?'=>pack("C",154),'£'=>pack("C",156),'¥'=>pack("C",157),'_'=>pack("C",158),
